...
public enum PlaneModel {
    ...
    BOMBARDIER_CHALLENGER("BOMBARDIER", "Challenger", 300, 250),
    BOMBARDIER_CRJ100("BOMBARDIER", "CRJ1000", 300, 250);
...
//TODO wstawic liczbę miejsc
    PlaneModel(String planeBrand, String planeModel, int regularSeats, int premiumSeats) {
