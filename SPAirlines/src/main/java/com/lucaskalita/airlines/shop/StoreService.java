...
import com.lucaskalita.airlines.ticket.*;
...
@Transactional
    private TicketDTO buyTicket(String username, Long flightId, SeatDetailsDTO seatDetailsDTO) {
        ...
        }else {throw new NoEmptySeatsException("No available space for this type");}
